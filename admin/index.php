		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 1000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into job values('','$nama_job','$kualifikasi','$masa_berlaku','$path','Active')";
                ...
                <div class="row mt-5 mb-5">
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$job=mysqli_query($conn,"SELECT * from job where id_job > 1 and status='Active' order by id_job ASC");
											$no=1;
											while($p=mysqli_fetch_array($job)){
													$date2 = $p['masa_berlaku'];
													$nama_job = $p['nama_job'];
													$id_job = $p['id_job'];
													$gamber = $p['img'];
												?>
												...
												<tr>
													...
													<form action="index.php" method="post" enctype="multipart/form-data" >
														...
														<div class="dropdown-menu">
														  <input type="button" class="dropdown-item" data-toggle="modal" data-target="#activejob<?php echo $id_job ?>" value="Edit" \>
											...
											<!-- modal input -->
														<div id="activejob<?php echo $id_job ?>" class="modal fade">
																	...
																	<div class="modal-body">
																		<form action="index.php" method="post" enctype="multipart/form-data" >
																			<div class="form-group">
																				...
																				<input name="editjob" type="text" class="form-control" value="<?php echo $p['nama_job'] ?>">
																			</div>
																			<div class="form-group">
																				<label>Kualifikasi</label>
																				<input name="editreq" type="text" class="form-control" value="<?php echo $p['kualifikasi'] ?>">
																			</div>
																			<div class="form-group">
												...
												if($date_now > $date2){	
													$pindahstatus = "update job set status='Inactive' where id_job='$id_job'";
											...
											if(isset($_POST["hapus1"])){
													$hapusin = mysqli_query($conn,"delete from job where id_job='$id_job'");
													if($hapusin){
														unlink($gamber);
											...
											if(isset($_POST["simpan2"])){
												...
												$editdate = $_POST['editdate'];
													$simpanin = mysqli_query($conn,"update job set nama_job='$editjob', kualifikasi='$editreq', masa_berlaku='$editdate' where id_job='$id_job'");
													if($simpanin){
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2><u>Kelola Lowongan Inactive</u></h2>
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable2" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$job=mysqli_query($conn,"SELECT * from job where id_job > 1 and status='Inactive' order by id_job ASC");
											$no=1;
											while($p=mysqli_fetch_array($job)){
													$date2 = $p['masa_berlaku'];
													$nama_job = $p['nama_job'];
												...
												<tr>
													...
													<form action="index.php" method="post" enctype="multipart/form-data" >
														...
														<div class="dropdown-menu">
														  <input type="button" class="dropdown-item" data-toggle="modal" data-target="#inactivejob<?php echo $id_job ?>" value="Edit" \>
												...
												<!-- modal input -->
														<div id="inactivejob<?php echo $id_job ?>" class="modal fade">
															<div class="modal-dialog">
																<div class="modal-content">
																	<div class="modal-header">
																		<h4 class="modal-title">Edit Job</h4>
												...
												if($date_now <= $date2){	
													$pindahstatus = "update job set status='Active' where id_job='$id_job'";
													$jalanquery = mysqli_query($conn, $pindahstatus);
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="index.php" method="post" enctype="multipart/form-data" >
								...
								<div class="form-group">
									<label>Kualifikasi</label>
									<input name="kualifikasi" type="text" class="form-control" placeholder="Kualifikasi">
								</div>
								<div class="form-group">
									<label>Tanggal berakhir</label>
									<input name="masa_berlaku" type="date" class="form-control">
								</div>
								<div class="form-group">
									<label>Gambar</label>

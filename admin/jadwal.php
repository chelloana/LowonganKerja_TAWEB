                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											$job=mysqli_query($conn,"SELECT pelamar.nama_pelamar, jadwal.alamat, jadwal.tanggal, jadwal.pic, jadwal.telepon_pic FROM pelamar, jadwal WHERE pelamar.id_pelamar = jadwal.id_pelamar");
											$no=1;
											while($p=mysqli_fetch_array($job)){
												$tgls = $p['tanggal'];
												$tanggal = date_create($tgls);
												$tgl = date_format($tanggal,'D, d F Y');
												$waktu = date_format($tanggal,'H:i');
												?>
